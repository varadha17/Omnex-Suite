...
public class Loginpage extends BaseClass {
	...
	@FindBy(xpath="//img[@src='/EwQIMS/instancedata/common/Documents/Companylogo/ewims-logo.png']")
	WebElement Img;
	...
	public HomePage LoginEnter() throws IOException, InterruptedException{
		...
		if(s1.equalsIgnoreCase("http://192.168.100.248/ewqims/Common/EwIMSNew/Index/Index")){
